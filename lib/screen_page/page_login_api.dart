...
import 'package:latihanedukasi/screen_page/page_battom_navigation.dart';
import 'package:latihanedukasi/screen_page/page_register_api.dart';
...
class _PageLoginApiState extends State<PageLoginApi> {
  ...
  Future<ModelLogin?> loginAccount() async{
    ...
    try{
      ...
      http.Response response = await http.post(Uri.parse('http://10.126.0.69/edukasi_server2/login.php'),
          body: {
