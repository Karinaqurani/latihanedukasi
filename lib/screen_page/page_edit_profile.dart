...
import 'package:latihanedukasi/model/model_profil.dart';
import 'package:latihanedukasi/utils/session_manager.dart';
  ...
  Future<ModelProfile?> updateAccount() async {
    ...
    try {
      ...
      http.Response response = await http.post(
          Uri.parse('http://10.126.0.69/edukasi_server2/updateUser.php'),
          body: {
